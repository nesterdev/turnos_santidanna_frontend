...
export default function ShiftsForm() {
  ...
  const [breakTime, setBreakTime] = useState(120); // Valor por defecto: 120 min (2h)
    ...
    <div className="max-w-4xl mx-auto space-y-6 pb-12">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 bg-white p-6 rounded-2xl border border-gray-100 shadow-sm">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-xl font-bold text-gray-900 tracking-tight">Crear Nuevo Turno</h1>
            <p className="text-xs text-gray-500">Define horarios y descansos para asignación de empleados</p>
          </div>
        </div>
