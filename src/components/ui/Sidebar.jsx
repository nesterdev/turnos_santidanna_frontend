...
import logoImage from "../../assets/variedades_santidana_500x500.png";
...
export default function Sidebar() {
  ...
  useEffect(() => {
    ...
    return () =>
      document.removeEventListener("astro:page-load", updateActivePath);
  }, []);
          ...
          >
            <div className="flex items-center gap-2.5 overflow-hidden">
              ...
              <div className="truncate">
                ...
                <span
                  className={`inline-block px-1.5 py-0.2 rounded text-[9px] font-bold uppercase tracking-wider border mt-0.5 ${roleStyles[role] || roleStyles.worker}`}
                >
                  {role}
                </span>
              </div>
