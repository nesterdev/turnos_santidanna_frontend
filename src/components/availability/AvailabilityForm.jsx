        ...
        >
          ...
          <div className="flex justify-end items-center gap-3 border-t border-gray-100 pt-6">
            ...
            <button
              type="submit"
              disabled={loading}
              className="px-6 py-2.5 rounded-xl bg-black hover:bg-gray-800 active:scale-95 text-white font-semibold text-xs transition cursor-pointer disabled:opacity-50 flex items-center justify-center gap-2"
            >
              {loading && (
  ...
  return (
    <div
      ...
      className={`p-4 rounded-2xl border cursor-pointer transition-all duration-200 flex items-center justify-between select-none ${
        active
          ? "border-black bg-white ring-2 ring-black/5 shadow-xs"
